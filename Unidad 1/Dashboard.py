...
def mostrar_codigo(ruta_script):
    ...
    Args:
        ruta_script (str): Ruta al archivo del script.
    """
...
def ejecutar_codigo(ruta_script):
    """
    Ejecuta el script especificado en una nueva terminal.
...
def mostrar_menu():
    ...
    # Aquí cambié las unidades para que reflejen la estructura de mi repositorio
    unidades = {
        '1': 'Unidad 1',
        '2': 'Unidad 2',
        '3': 'Unidad 3',
...
def mostrar_sub_menu(ruta_unidad):
    """
    Muestra el submenú para seleccionar subcarpetas dentro de una unidad.

    Args:
        ruta_unidad (str): Ruta a la carpeta de la unidad.
    """
...
def mostrar_scripts(ruta_sub_carpeta):
    """
    Muestra los scripts disponibles en la subcarpeta seleccionada y permite ver y ejecutar cada uno.

    Args:
        ruta_sub_carpeta (str): Ruta a la subcarpeta seleccionada.
    """
