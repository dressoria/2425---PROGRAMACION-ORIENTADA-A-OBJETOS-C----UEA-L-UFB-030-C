# Aqui ponemos la definición de la clase Producto
class Producto:
...
# Aqui ponemos la Definición de la clase Cliente
class Cliente:
...
# Aqui ponemos la Definición de la clase Tienda
class Tienda:
    def __init__(self, nombre):
        self.nombre = nombre
        self.productos = []
...
# Aqui ponemos el Ejemplo de uso del sistema
